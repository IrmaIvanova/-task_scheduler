...
// const { bemElClassName:CalendarBody } = createBem('CalendarBody');
...
//     return (
//         <div className={CalendarBody(`${theme}`)}>
//             {weekdaysRender}
//             {daysRender}
